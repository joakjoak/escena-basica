...
const place = fullPath.split("?")[0];
const number = fullPath.split("?")[1];
...
function init() {
  ...
  var texturePath = "../videos/" + place + "/" + number + ".mp4";
  ...
  video.setAttribute("src", texturePath); //acá tiene que tener el coso del json
